...
INPUT_FILES = {
    ...
    "GSE218890_Dp16_Norm_Mesenteric_lymph_nodes_GencodevM24_counts.txt",
...
OUTPUT_FILES = {
    "mice_gene_expr_mesenteric_lymph_nodes_rpkm_std": conf.data.MICE_PROCESSED_DIR
    / "mice_gene_expr_mesenteric_lymph_nodes_rpkm_std.ftr",
    "mice_gene_expr_mesenteric_lymph_nodes_rpkm_std_log": conf.data.MICE_PROCESSED_DIR
    / "mice_gene_expr_mesenteric_lymph_nodes_rpkm_std_log.ftr",
}
...
rpkm_normalized_df = pe.calculate_rkpm_normalization(INPUT_FILES["gene_count"], INPUT_FILES["gene_length"], INPUT_FILES["extended_gene_pathway"],
                 OUTPUT_FILES["mice_gene_expr_mesenteric_lymph_nodes_rpkm_std"])  
...
rpkm_normalized_df_log.to_feather(OUTPUT_FILES["mice_gene_expr_mesenteric_lymph_nodes_rpkm_std_log"])
